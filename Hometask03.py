...
# Sort the list by age and sex fields
...
# Create a new list without the first two elements and last two elements
...
# Calculate the counts of "female" and "male" in the new list
...
for sex, count in counts.items():
    print(f"|  {sex:<6} |  {count}{' ' * (3 - len(str(count)))}  |")
print("-----------------")